...
<html lang="en">
  ...
  <?php
    if(isset($_POST['post'])){
            ...
            $sql="INSERT INTO doing(name, description) VALUES('$tieude','$noidung')";
  ...
  ?>
      ...
      <div class="container">
        <h1 class="text-center text-uppercase font-italic font-weight-light" >Thêm mới</h1>
        <br>
        <form action="" method ="POST" enctype="multipart/form-data">
            ...
            <button name="post" type="submit" class="btn btn-success">Thêm</button>
        </form>
      </div>
    <!-- Optional JavaScript -->
